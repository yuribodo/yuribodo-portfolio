...
| Character | Creator / model | Listed geometry and animation | Integration assessment |
| --- | --- | --- | --- |
| Veldora — That Time I Got Reincarnated as a Slime | kam — [Veldora Tempest](https://sketchfab.com/3d-models/veldora-tempest-from-tensura-slime-35bdf0507cd94825bbb3ea37ae9f6632) | 986,506 triangles; no animation listed | Strongest connection to the user's Slime reference. Author mentions accidentally mixed high-poly geometry. Requires mesh cleanup, optimization, rig inspection and a proper flight cycle; not ready to drop into the site. |
| Toothless / Banguela — How to Train Your Dragon | Stuck On Saturn — [Toothless (Rigged)](https://sketchfab.com/3d-models/toothless-rigged-httyd-91d8197bf907439daa1bd78ad6a775cc) | 55,696 triangles; rig advertised; no animation listed | Recognizable silhouette and detailed surface. Need inspect exported skeleton and create/bake a convincing flight cycle. A rig is not a finished animation. |
| Shenron / Shenlong — Dragon Ball | Yanez Designs — [Shenron (Dragon Ball)](https://sketchfab.com/3d-models/shenron-dragon-ball-96e8ad1e206941ce859c5733bec75d30) | 25,028 triangles; no animation listed | Immediately recognizable green serpentine silhouette. Coiled static pose needs rigging/reposing work before a natural airborne path. |
